...
<body>
	...
	<main>
		...
		<h1 class="slideInDown animated">
			<?php echo $edit_student ? "Edit Student Information" : "Register Student Using RFID Card"; ?>
		</h1>
...
===================================================== -->
		<div class="form-style-5 slideInDown animated">
			<form method="POST" action="register_student.php">
				...
				<!-- -------- ACTION -------- -->
				<button type="submit">
					<?php echo $edit_student ? "Update Student" : "Register Student"; ?>
				</button>

				<?php if ($edit_student): ?>
					<a href="ManageUsers.php" style="margin-left:10px;">Cancel Edit</a>
				<?php endif; ?>

...
$allowed_tabs = ['devices', 'room_devices', 'batch_rooms', 'relations'];
...
<head>
  ...
  <style>
    ...
    thead th{position:sticky;top:0;z-index:2;background:#ffffff;color:#000;font-size:12px;text-transform:uppercase;letter-spacing:.06em;padding:12px 14px;text-align:left;border-bottom:1px solid var(--line);box-shadow:0 1px 0 rgba(0,0,0,.04);}
  ...
  <div class="card">
    <div class="head">
      ...
      <div class="tabs">
        ...
        <a class="tab" href="rooms.php">Rooms (separate)</a>
      </div>
    </div>
    ...
    <div class="body">
      ...
      <?php if ($flash): ?>
        <div class="msg <?= h($flash['type']) ?>"><?= h($flash['msg']) ?></div>
